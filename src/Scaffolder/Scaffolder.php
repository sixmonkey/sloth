...
class Scaffolder
{
    ...
    public function __construct()
    {
        ...
        $this->composer_config          = json_decode(
            file_get_contents($this->composer_config_location . 'composer.json'),
            true
        );
    }
    ...
    public function create_module()
    {
        ...
        while ($context['name'] == null || file_exists($filename_module)) {
            ...
            if (file_exists($filename_module)) {
                $this->climate->error(Emoji::pileOfPoo() . ' ' . sprintf(
                    'A module called %s exists!',
                    $context['name']
                ));
            }
        }
        ...
        */
        ...
        if ($context['layotter']) {
            ...
            if (file_exists($filename_acf)) {
                $this->climate->info(Emoji::thinkingFace() . ' ' . sprintf(
                    'A Field Group %s exists. Skipping scaffolding!',
                    $context['name_acf']
                ));
            } else {
