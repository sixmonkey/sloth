...
class Installer
{
    ...
    public static $dir_theme_new;
    public static $dirs_required = [
        ['app'],
        ['app', 'config'],
        ['app', 'cache'],
    ];
    public static $http_dir;
    public static $theme_name;
    public static $themedescription;

    public static function buildStyleCss()
    {
        @file_put_contents(
            self::$dir_theme_new . DIRECTORY_SEPARATOR . 'style.css',
